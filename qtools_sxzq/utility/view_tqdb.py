...
if __name__ == "__main__":
    from qtools_sxzq.qdataviewer import CDataViewerTqdb, CArgsParserViewerTgdb

    args_parser = CArgsParserViewerTgdb()
    ...
    data_viewer = CDataViewerTqdb(lib=args.lib, table=args.table)

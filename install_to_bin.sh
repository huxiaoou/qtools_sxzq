chmod u+x qtools_sxzq/utility/*py
cp qtools_sxzq/utility/cls_prv_cache.py /usr/local/bin/cls_prv_cache
cp qtools_sxzq/utility/ls_tqdb.py /usr/local/bin/ls_tqdb
